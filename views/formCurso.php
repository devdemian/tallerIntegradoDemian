    ...
    <div class="contai">
        ...
        <div class="credits">
            <div class="form_curso">
                <div class="col-md-8">
                    <h2 class="mb-4" style="text-align: center;">Agregar Curso</h2>
                    <form>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <select id="nivel_dificultad" class="form-control">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="number" class="form-control" id="horas" placeholder="Ingrese la cantidad de horas">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="lenguaje">Lenguaje</label>
                        <input type="text" class="form-control" id="lenguaje" placeholder="Ingrese el lenguaje del curso">
                      </div>
